...
class TideLandingPageOperation {
  ...
  public static function assignNecessaryPermissions() {
    $role_permissions = [
      'editor' => [
        'clone landig_page content',
        'create landig_page content',
        'edit any landig_page content',
        'edit own landig_page content',
        'revert landig_page revisions',
        'view landig_page revisions',
      ],
      'site_admin' => [
        'add scheduled transitions node landig_page',
        'clone landig_page content',
        'create landig_page content',
        'delete any landig_page content',
        'delete landig_page revisions',
        'delete own landig_page content',
        'edit any landig_page content',
        'edit own landig_page content',
        'revert landig_page revisions',
        'view landig_page revisions',
        'view scheduled transitions node landig_page',
      ],
      'approver' => [
        'add scheduled transitions node landig_page',
        'create landig_page content',
